...
public extension TUIGradient {
    static let darkGradientSubjectMap: [String: CurrentValueSubject<BaseGradient, Never>] = {
        [
            ...
            "overlayRecCardSparksSuperLike": CurrentValueSubject<BaseGradient, Never>(
                BaseGradient(
                    colors: [
                        .init(red: 0.06274509803921569, green: 0.4196078431372549, blue: 0.8352941176470589, alpha: 0.0),
                        .init(red: 0.06274509803921569, green: 0.4196078431372549, blue: 0.8352941176470589, alpha: 0.3),
                        .init(red: 0.06274509803921569, green: 0.4196078431372549, blue: 0.8352941176470589, alpha: 0.7),
                        .init(red: 0.06274509803921569, green: 0.4196078431372549, blue: 0.8352941176470589, alpha: 1.0),
                        .init(red: 0.06274509803921569, green: 0.4196078431372549, blue: 0.8352941176470589, alpha: 1.0)
                    ],
                    angle: 180,
            ...
            "overlayProfileButtonGamepad": CurrentValueSubject<BaseGradient, Never>(
                BaseGradient(
                    colors: [
                        .init(red: 0.06666666666666667, green: 0.0784313725490196, blue: 0.09411764705882353, alpha: 0.0),
                        .init(red: 0, green: 0, blue: 0, alpha: 1.0)
                    ],
                    angle: 180,
                    positions: [0, 1]
